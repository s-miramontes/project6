...
class BaseRegressor():
    ...
    def train_model(self, X_train, y_train, X_val, y_val):
        ...
        while prev_update_size > self.tol and iteration < self.max_iter:
            ...
            # Iterating through batches (full for loop is one epoch of training), training denoted by batches
            for X_train, y_train in zip(X_batch, y_batch):

                # Making prediction on batch
                y_pred = self.make_prediction(X_train) # your TODO

                # Calculating loss
                loss_train = self.loss_function(X_train, y_train) # your TODO
                ...
                grad = self.calculate_gradient(X_train, y_train) #your TODO
